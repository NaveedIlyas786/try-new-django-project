...
from .views import EstimatingListView,AddendumView,QualificationView,SpecificationViews,SpecificationDetailViews,LocationViews,Estimating_detailView,create_proposal,ProposalServiceView,ProposalView
