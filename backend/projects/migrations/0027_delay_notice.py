    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delay_num', models.IntegerField(blank=True, verbose_name='Delay Number #')),
                ...
                ('gnrl_cntrctr', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Estimating.gc_detail', verbose_name='General Contractor')),
                ('if_yes_rfi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='projects.rfi', verbose_name='select the RFI')),
